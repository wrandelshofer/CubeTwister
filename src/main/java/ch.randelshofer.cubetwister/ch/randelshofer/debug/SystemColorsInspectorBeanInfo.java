/* @(#)SystemColorsInspectorBeanInfo.java
...
public class SystemColorsInspectorBeanInfo extends SimpleBeanInfo {
...
//GEN-HEADEREND:BeanDescriptor
        ...
        if (beanDescriptor == null) beanDescriptor = new BeanDescriptor(SystemColorsInspectorBeanInfo.class);
