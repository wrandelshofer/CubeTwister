...
public class RubiksBarrelGeom3D extends AbstractRubiksCubeGeom3D {
    ...
    protected void initActions() {
        ...
        for (i=0; i < 8; i++) {
            ...
            shapes[index].setAction(2, new PartAction(index, 1, getStickerIndexForPart(index, 1)));
            shapes[index].setAction(3, new PartAction(index, 2, getStickerIndexForPart(index, 2)));
            ...
            switch (i) {
                ...
                case 10 :
                    for (j=0; j < 2; j++) {
                        ...
                        shapes[index].setAction(j + 1, new PartAction(index, j, getStickerIndexForPart(index, j)));
                switch (j) {
                    case 0:
        ...
        for (i=0; i < 6; i++) {
            ...
            shapes[index].setAction(0, new PartAction(index, 0, getStickerIndexForPart(index, 0)));
            shapes[centerOffset].setAction(i, new PartAction(26, i, -1));
