/* @(#)CubeDimensionsViewBeanInfo.java
...
public class CubeDimensionsViewBeanInfo extends SimpleBeanInfo {
...
//GEN-HEADEREND:BeanDescriptor
        ...
        if (beanDescriptor == null) beanDescriptor = new BeanDescriptor(CubeDimensionsViewBeanInfo.class);
