...
public class ScriptViewBeanInfo extends SimpleBeanInfo {
...
//GEN-HEADEREND:BeanDescriptor
        ...
        if (beanDescriptor == null) beanDescriptor = new BeanDescriptor(ScriptViewBeanInfo.class);
