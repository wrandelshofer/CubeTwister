/*
 * @(#)ScriptPrimaryViewBeanInfo.java
...
public class ScriptPrimaryViewBeanInfo extends SimpleBeanInfo {
...
//GEN-HEADEREND:BeanDescriptor
        ...
        if (beanDescriptor == null) beanDescriptor = new BeanDescriptor(ScriptPrimaryViewBeanInfo.class);
