/* @(#)ScriptOptionsViewBeanInfo.java
...
public class ScriptOptionsViewBeanInfo extends SimpleBeanInfo {
...
//GEN-HEADEREND:BeanDescriptor
        ...
        if (beanDescriptor == null) beanDescriptor = new BeanDescriptor(ScriptOptionsViewBeanInfo.class);
