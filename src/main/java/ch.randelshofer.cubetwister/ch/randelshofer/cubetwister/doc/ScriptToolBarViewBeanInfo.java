/* @(#)ScriptToolBarViewBeanInfo.java
...
public class ScriptToolBarViewBeanInfo extends SimpleBeanInfo {
...
//GEN-HEADEREND:BeanDescriptor
        ...
        if (beanDescriptor == null) beanDescriptor = new BeanDescriptor(ScriptToolBarViewBeanInfo.class);
