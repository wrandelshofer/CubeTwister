...
public class CubeStickersViewBeanInfo extends SimpleBeanInfo {
...
//GEN-HEADEREND:BeanDescriptor
        ...
        if (beanDescriptor == null) beanDescriptor = new BeanDescriptor(CubeStickersViewBeanInfo.class);
