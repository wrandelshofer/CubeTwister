/* @(#)NotationMovesViewBeanInfo.java
...
public class NotationMovesViewBeanInfo extends SimpleBeanInfo {
...
//GEN-HEADEREND:BeanDescriptor
        ...
        if (beanDescriptor == null) beanDescriptor = new BeanDescriptor(NotationMovesViewBeanInfo.class);
