 ...
 */
public class LazyEntityViewBeanInfo extends SimpleBeanInfo {
...
//GEN-HEADEREND:BeanDescriptor
        ...
        if (beanDescriptor == null) beanDescriptor = new BeanDescriptor(LazyEntityViewBeanInfo.class);
