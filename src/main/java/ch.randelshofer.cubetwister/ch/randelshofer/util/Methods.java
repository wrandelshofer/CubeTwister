...
public class Methods {
     ...
     * @return NoSuchMethodException if the method does not exist or is not accessible.
     */
    public static Object invokeStatic(@Nonnull Class<?> clazz, @Nonnull String methodName, Class<?>[] types, Object[] values)
            throws NoSuchMethodException {
        try {
     ...
     * @return The value returned by the getter method or the default value.
     */
    public static boolean invokeStaticGetter(@Nonnull Class<?> clazz, @Nonnull String methodName, boolean defaultValue) {
        try {
            Method method = clazz.getMethod(methodName, new Class<?>[0]);
            Object result = method.invoke(null, new Object[0]);
            return ((Boolean) result).booleanValue();
