...
public class TarArchiveEntry implements ArchiveEntry {
     ...
     */
    private StringBuilder m_linkName;

    /**
     * The entry's link name.
     */
    private StringBuilder m_magic;
     ...
     */
    private StringBuilder m_userName;
    ...
    {
        m_magic = new StringBuilder( TarConstants.TMAGIC );
        ...
        m_userName = new StringBuilder( user );
        m_groupName = new StringBuilder( "" );
    }
