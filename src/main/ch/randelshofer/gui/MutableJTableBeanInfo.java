...
public class MutableJTableBeanInfo extends SimpleBeanInfo {
...
//GEN-HEADEREND:BeanDescriptor
        ...
        if (beanDescriptor == null) {
            beanDescriptor = new BeanDescriptor(MutableJTableBeanInfo.class);
        }
        beanDescriptor.setValue("isContainer", Boolean.FALSE);
        beanDescriptor.setDisplayName("MutableJTable");
