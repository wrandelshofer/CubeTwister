/* @(#)NotationMacrosViewBeanInfo.java
...
public class NotationMacrosViewBeanInfo extends SimpleBeanInfo {
...
//GEN-HEADEREND:BeanDescriptor
        ...
        if (beanDescriptor == null) beanDescriptor = new BeanDescriptor(NotationMacrosViewBeanInfo.class);
