/*
 * @(#)NotationConstructsViewBeanInfo.java
...
public class NotationConstructsViewBeanInfo extends SimpleBeanInfo {
...
//GEN-HEADEREND:BeanDescriptor
        ...
        if (beanDescriptor == null) beanDescriptor = new BeanDescriptor(NotationConstructsViewBeanInfo.class);
