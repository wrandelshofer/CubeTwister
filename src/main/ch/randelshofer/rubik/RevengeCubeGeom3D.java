/*
 * @(#)RevengeCubeGeom3D.java  2.1  2010-04-04
...
public class RevengeCubeGeom3D extends AbstractRevengeCubeGeom3D {
    ...
    protected void initActions() {
        ...
        for (i=0; i < edgeCount; i++) {
            ...
            for (j=0; j < 2; j++) {
                shapes[index].setAction(j, new AbstractCube6Geom3D.PartAction(index, j, getStickerIndexForPart(index, j)));
                switch (j) {
                    case 0: {
        ...
        for (i=0; i < sideCount; i++) {
            ...
            shapes[index].setAction(0, new AbstractCube6Geom3D.PartAction(index, 0, getStickerIndexForPart(i+sideOffset, 0)));
