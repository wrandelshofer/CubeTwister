/*
 * @(#)DesktopPropertiesInspectorBeanInfo.java
...
public class DesktopPropertiesInspectorBeanInfo extends SimpleBeanInfo {
...
//GEN-HEADEREND:BeanDescriptor
        ...
        if (beanDescriptor == null) beanDescriptor = new BeanDescriptor(DesktopPropertiesInspectorBeanInfo.class);
