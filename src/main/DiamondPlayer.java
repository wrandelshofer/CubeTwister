...
public class DiamondPlayer extends RubiksDiamondPlayerIdx3DApplet {
    ...
    public static void main(String args[]) {
        AbstractPlayerApplet.main(new DiamondPlayer(), args);
    }
