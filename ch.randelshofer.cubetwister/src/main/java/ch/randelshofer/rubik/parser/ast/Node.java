...
public abstract class Node extends TreeNodeImpl<Node> {
     ...
     * notation.
     */
    public final String toString(@Nonnull ScriptNotation notation) throws IOException {
     ...
     */
    public final String toString(@Nonnull ScriptNotation notation, @Nullable List<MacroNode> localMacros) throws IOException {
     ...
     */
    public void writeTokens(Writer w, @Nonnull ScriptNotation n, Map<String, MacroNode> macroMap)
            throws IOException {
