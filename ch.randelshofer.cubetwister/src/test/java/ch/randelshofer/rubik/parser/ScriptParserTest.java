...
import ch.randelshofer.rubik.parser.ast.PermutationItemNode;
...
class ScriptParserTest {
    ...
    @Nonnull
    DefaultScriptNotation defaultNotatioon = new DefaultScriptNotation();
    @Nonnull
    DefaultScriptNotation defaultNotatioon4 = new DefaultScriptNotation(4);
    @Nonnull
    DefaultScriptNotation precircumfix = new DefaultScriptNotation();
    @Nonnull
    DefaultScriptNotation preinfix = new DefaultScriptNotation();
    @Nonnull
    DefaultScriptNotation postinfix = new DefaultScriptNotation();
    @Nonnull
    DefaultScriptNotation prefix = new DefaultScriptNotation();
    @Nonnull
    DefaultScriptNotation circumfix = new DefaultScriptNotation();
    @Nonnull
    DefaultScriptNotation postcircumfix = new DefaultScriptNotation();
    @Nonnull
    DefaultScriptNotation suffix = new DefaultScriptNotation();
    @Nonnull
    DefaultScriptNotation mixed = new DefaultScriptNotation();
    @Nonnull
    DefaultScriptNotation mixedB = new DefaultScriptNotation();
    @Nonnull
    DefaultScriptNotation notationWithMacros = new DefaultScriptNotation();
    ...
    public List<DynamicTest> testParseAppliedPermutation() {
        final DefaultScriptNotation notation7x7 = new DefaultScriptNotation(7);
        final Cube7 cube7 = new Cube7();
        cube7.transform(0, 32 + 64, 1);

        final DefaultScriptNotation notation6x6 = new DefaultScriptNotation(6);
        final Cube6 cube6 = new Cube6();
        cube6.transform(0, 16 + 32, 1);

        final DefaultScriptNotation notation5x5 = new DefaultScriptNotation(5);
        final ProfessorCube cube5 = new ProfessorCube();
        cube5.transform(0, 8 + 16, 1);

        final DefaultScriptNotation notation4x4 = new DefaultScriptNotation(4);
        final RevengeCube cube4 = new RevengeCube();
        cube4.transform(0, 4 + 8, 1);

        final DefaultScriptNotation notation3x3 = new DefaultScriptNotation(3);
        final RubiksCube cube3 = new RubiksCube();
        cube3.transform(0, 2 + 4, 1);

        final DefaultScriptNotation notation2x2 = new DefaultScriptNotation(2);
    ...
    public void doParsePermutation(@Nonnull ScriptNotation notation, @Nonnull Cube cube) throws Exception {
     ...
     */
    public void doParse(@Nonnull ScriptNotation notation, @Nonnull String script, String expected) throws Exception {
    ...
    public void doFailure(ScriptNotation notation, String script, String expected) throws Exception {
        ScriptParser instance = new ScriptParser(notation);
        try {
